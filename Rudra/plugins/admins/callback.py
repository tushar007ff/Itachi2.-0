...
from Rudra.utils.database import get_assistant
...
from Rudra.utils.inline import close_markup, stream_markup, stream_markup_timer
from Rudra.utils.inline.play import panel_markup_1, panel_markup_2, panel_markup_3
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Rudra.resume_stream(chat_id)
        buttons_resume = [
        [
        ...
        await Rudra.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await Rudra.unmute_stream(chat_id)
        await CallbackQuery.message.reply_text(
